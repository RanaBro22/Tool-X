        ...
        if system.connection():
          ...
          if system.sudo != None:
            if os.path.exists(system.home+"/Tool-X"):
              ...
              os.system(system.sudo+" git clone https://github.com/RanaBro22/Tool-X.git "+system.home+"/Tool-X")
            ...
            if os.path.exists(system.home+"/Tool-X"):
              ...
              os.system("git clone https://github.com/RanaBro22/Tool-X.git "+system.home+"/Tool-X")
            if os.path.exists(system.home+"/Tool-X/install.aex"):
